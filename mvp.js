...
const defaults={
  ...
  business:{active:true,license:'NSQ-B-DEMO-001',company:'Nusoq Demo Engineering',includedSeats:INCLUDED_BUSINESS_SEATS,role:'Owner',tools:['boq','specs','cost','tasks']},
  sallaUrl:'',lastUpdated:new Date().toISOString()
};
const defaultTeam=[
...
window.Nusoq={account,save,setMode,mode,workspace,hasTool,status,team,saveTeam,seatInfo,INCLUDED_BUSINESS_SEATS,mountShell,syncShell,requireTool,TOOLS,showActivation};
