...
function patchAll(){patchTable(document.querySelector('.boq'))}
...
function start(){const body=document.querySelector('#body');if(body)obs.observe(body,{childList:true,subtree:true});patchAll();setTimeout(patchAll,500)}
window.NUSOQ_ITEM_CODE=code;
